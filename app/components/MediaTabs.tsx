      ...
      <div className="flex flex-wrap gap-2 border-b border-gray-200 mb-8">
        {tabs.map((tab) => (
          <button
            ...
            className={`
              px-6 py-3 text-sm font-medium rounded-t-lg transition-all duration-200 flex items-center gap-2
              ${
                activeTab === tab.id
                      ...
                      <div className="mt-4">
                        {video.fileUrl ? (
                          ...
                          <a
                            ...
                            className="inline-block text-primary-600 hover:text-gold-500 text-sm font-medium"
                          >
                            Tazama Video (nje) →
                          </a>
                        ) : null}
